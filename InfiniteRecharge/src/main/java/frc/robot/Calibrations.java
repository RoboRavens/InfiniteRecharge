...
public class Calibrations {
	...
	public static final double GYRO_ADJUSTMENT_DEFAULT_SCALE_FACTOR = .0065;
	public static final double DRIVE_TRAIN_TURN_RELATIVE_DEGREES_GYRO_ADJUSTMENT_SCALE_FACTOR = .0065;
