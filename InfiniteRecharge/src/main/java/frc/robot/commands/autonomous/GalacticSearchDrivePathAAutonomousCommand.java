...
public class GalacticSearchDrivePathAAutonomousCommand {
  public static Command GenerateCommand() {
    ...
    return new SequentialCommandGroup(
        ...
        new DriveTrainDriveInchesCommand(firstDiagonal, 1, Calibrations.DRIVING_FORWARD),
        new DriveTrainTurnRelativeDegreesCommand(drivetrain, -120),
        new DriveTrainDriveInchesCommand(northDistance, 1, Calibrations.DRIVING_FORWARD),
