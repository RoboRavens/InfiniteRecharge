...
/**
 * Turns the robot -> shoots -> turns back -> goes straight and picks up balls
 * in trench
 */
public class SixBallSideAutonomousCommand {
    public static Command GenerateCommand() {
        ...
        var returnToStartReversedTrajectory = TrajectoryGenerator.generateTrajectory(
                new Pose2d(4, 0, new Rotation2d(0)), List.of(), new Pose2d(0, 0, new Rotation2d(0)),
        ...
        return new SequentialCommandGroup(
                ...
                // new DriveTrainTurnRelativeDegreesCommand(Robot.DRIVE_TRAIN_SUBSYSTEM, 25.5),
                new ParallelDeadlineGroup(new DriveTrainDriveInchesCommand(200, .3, Calibrations.DRIVING_FORWARD),
                        new IntakeExtendAndCollectCommand()),
                new IntakeRetractCommand(), new DriveTrainDriveInchesCommand(200, .3, Calibrations.DRIVING_BACKWARD),
                // new DriveTrainTurnRelativeDegreesCommand(Robot.DRIVE_TRAIN_SUBSYSTEM, -25.5),
                new ShooterAutonomousShootCommand()
        // new DriveTrainTurnRelativeDegreesCommand(Robot.DRIVE_TRAIN_SUBSYSTEM, 25.5)
        );
