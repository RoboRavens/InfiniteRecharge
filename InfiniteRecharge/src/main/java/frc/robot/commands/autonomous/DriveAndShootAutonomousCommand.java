...
public class DriveAndShootAutonomousCommand {
  public static Command GenerateCommand() {
    /* var drive1FootTrajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)), List.of(),
        new Pose2d(1, 0, new Rotation2d(0)), Robot.DRIVE_TRAIN_SUBSYSTEM.ravenTank.getTrajectoryConfig());
