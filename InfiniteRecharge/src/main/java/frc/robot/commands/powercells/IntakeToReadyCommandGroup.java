...
public class IntakeToReadyCommandGroup extends ParallelCommandGroup {

  public IntakeToReadyCommandGroup() {
    super(new IntakeExtendAndCollectCommand(), new ConveyanceReadyToShootCommand(), new HopperReadyShotCommand());
  }
}
