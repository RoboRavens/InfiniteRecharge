...
public class BufferedValue {
	 ...
	 * @param n    the position of the desired object, using the ordering defined on
	 *             the list elements
	...
	public static <T> T nth(LinkedList<T> coll, int n, Comparator<T> comp) {
		...
		// this implementation uses the simple strategy of grabbing something from the
		...
		if (n < underPivot.size())
			...
			result = pivot;
		else // everything in underPivot and equalPivot is too small. Adjust n accordingly in
				// the recursion.
